...
CREATE TABLE `estancia` (
  `pintura` int DEFAULT NULL,
  `museos` int DEFAULT NULL,
  `ID` int NOT NULL,
  `año` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `pintura` (`pintura`,`museos`,`año`),
  KEY `museos` (`museos`),
  CONSTRAINT `estancia_ibfk_1` FOREIGN KEY (`pintura`) REFERENCES `pintura` (`ID`),
  CONSTRAINT `estancia_ibfk_2` FOREIGN KEY (`museos`) REFERENCES `museos` (`ID`)
...
CREATE TABLE `museos` (
  ...
  `ID` int NOT NULL,
  `tipoMuseo` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `uqMuseos` (`pais`,`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pintura` (
  ...
  `añoDCreacion` int DEFAULT NULL,
  `ID` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `uqPintura` (`titulo`,`autor`,`añoDCreacion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-02 20:34:24
