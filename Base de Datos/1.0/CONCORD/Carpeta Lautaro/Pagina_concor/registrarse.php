...
if (isset($_POST['email']) and isset($_POST['password']) and isset($_POST['nombre']) and isset($_POST['apellido']) and isset($_POST['name'])){
    $query = "INSERT INTO usuarios(nombre_apellido, contraseña, nombre_usuario, gmail) VALUES ('".$_POST['nombre']." ".$_POST['apellido']."','".$_POST['password']."','".$_POST['name']."','".$_POST['email']."')"or
