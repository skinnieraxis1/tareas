...
<head>
    ...
    <link rel="stylesheet" href="../Pagina_concor/assets/css/styleInde.css">
</head>
<body>
    ...
    <?php
        if($_SESSION['usuario']!=""){
            echo '<div class="fixed-action-btn" id="perfil">';
            ...
            echo '<li><a href="../Pagina_concor/config.php" class="btn-floating red"><i class="material-icons">build</i></a></li>';
